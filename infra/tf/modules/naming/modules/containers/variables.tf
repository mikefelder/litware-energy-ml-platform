# Variables for container resources naming module
variable "name" {
  type        = string
  description = "Base name for container resources"
  default     = ""
}

variable "prefixes" {
  type        = list(string)
  description = "List of prefixes to use for container resources"
  default     = []
}

variable "suffixes" {
  type        = list(string)
  description = "List of suffixes to append to container resources"
  default     = []
}
